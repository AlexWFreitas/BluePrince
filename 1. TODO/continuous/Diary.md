...
- Drafted a Clock Tower and noticed a puzzle related to the time 01:30
- Drafted a Kennel and noticed that there is a digging spot that is suspicious.
- Found a [[Inner Sanctum Key.canvas|Inner Sanctum Key]] on the [[015 - Music Room.canvas|015 - Music Room]] when drafted at Rank 9
- Bought three extra books on the Book Shop
	- The Clues
	- Drafting Strategy Vol 5
	- (Something about Runes)
- Ordered the Drafting Strategy Vol 5 on the Library
- Did Laboratory Experiments and earned 3 Stars + 1 from the Observatory
- Opened [[023 - Vault.canvas|023 - Vault]] 233 and found an allowance token and another fake passport with the name Grey Daniels.
- Used the [[Tunnel.canvas|Tunnel]] once, but it feels that there is something else, I need to try on a ruined run to check what happens if you draft like 8-9 rooms as Tunnels in a row.
- I tried to open the safe on the [[025 - Drawing Room.canvas|025 - Drawing Room]] again, but did not find a good logic for it. I feel that I need a book or something that would give me more info.
- Reached 41 Allowance and 32 Stars.
- Found a suspicious note on the Clock Tower.
- Discovered that Desilets waged war against General Teskin on the Fifth Era War related to [[Fenn Aries.canvas|Fenn Aries]]
- I called a day inside the Clock Tower to try to cause the 1:30 time puzzle on the next day with the Monk Blessing.

Day 33
- Drafted Clock Tower in the Outer Room through the Monk Blessing.
- Opened a secret room in the Clock Tower by waiting at the top of the tower until 01:30.
- Solved the puzzle in the Clock Tower secret room and earned a Inner Sanctum Key
- Used the Inner Sanctum Key on the third door in the Inner Sanctum, the next one will be the eighth door because of a note saying that one of the keys is behind the last door.
- Earned 2 allowance by reaching the Antechamber and drafting a Quest Bedroom, total 43.
- Earned 2 stars through a laboratory experiment and observatory, total 34.
- I tested the dig spot on The Kennel and found nothing.
- Read the Drafting Strategy Volume 5 book and took notes.
- Discovered two more ajeran angel names.
- Found a East Antechamber Lever inside one of the Great Hall doors.
- Discovered a bunch of recipes on the Workshop and combined one of the items into the Jack Hammer item, which improves digging results.
- Used Conservatory and adjusted room rarity on Passageway, Wine Cellar and Secret Passage.
- Entered the Trophy Room for the first time and noticed that it is a net positive room if you have the resources.
- Bought the Dare Mode unlock gift on the Holly Gift Shop for 110g.
