...
### Obtain the Freeze Room Secrets
- Need to place a Furnace near a Freeze Room

### Use Sledgehammer to break Vases on rooms
- Entrance Hall - 2 Vases - Microchip Item


### Discover the Unlisted Admin Keys from the Blackbridge Computer
- Already discovered entries
	- Randolph Moore - MoorR
...
- [[026 - Study.canvas|Study Canvas]] for tracking
...
- [x] Used it on Pump Room
	- Allows you to use the Reserve Tank
	- This allows you to drain the Reservoir completely
- [x] Used it on Laboratory Room
	- Enables the lever machine puzzle
	- Solving the lever, allows you to get one permanent upgrade
- [x] Used it on Furnace
	- This allows you to craft a single normal key
- [x] Used it on Laundry Room
	- This allows you to spend money on a Special Washing Machine that can allow you more options for money laundering.
	- One of the options allows you to swap Stars and Allowance
- [ ] Used it on Garage
...
- You can send power to the machine through the Boiler Room
- This opens up a cave and allows me to access one offline terminal from the network.
...
- You can find the Central Server Site on the room unlocked by solving the Laboratory Lever Machine Puzzle that requires power from the Boiler Room
- After finding the machine for the Central Server Site I can use BabbA to discover the other admin logins, such as MoorR or ThomK
- [x] Done